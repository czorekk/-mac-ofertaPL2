...
namespace Oferta__
{
    public partial class ViewController : NSViewController
    {
        ...
        partial void PotwierdzenieButton_Click(NSObject sender)
        {
            ...
            double kwvat = Convert.ToDouble(PriceText2.StringValue) * (Convert.ToDouble(Vat2.StringValue) / 100);
            ...
            MainClass.brutto = String.Format("{0:0.00}", (Convert.ToDouble(PriceText2.StringValue) + kwvat)).Replace(".", ",");
            MainClass.brutto10 = String.Format("{0:0.00}", ((Convert.ToDouble(PriceText2.StringValue) + kwvat) * 0.10)).Replace(".", ",");
            MainClass.brutto30 = String.Format("{0:0.00}", ((Convert.ToDouble(PriceText2.StringValue) + kwvat) * 0.30)).Replace(".", ",");
            MainClass.brutto60 = String.Format("{0:0.00}", ((Convert.ToDouble(PriceText2.StringValue) + kwvat) * 0.60)).Replace(".", ",");
