...
namespace Oferta__
{
    public class AllManager
    {
        ...
        {             float pom = 0;
            ...
            }             return Convert.ToString(pom).Replace(".",",");
        }
    }
}
